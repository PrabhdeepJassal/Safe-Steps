...
<module external.linked.project.id=":react-native-maps-lib" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../.." external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":react-native-maps-lib" />
      </configuration>
    </facet>
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: com.facebook.react:react-native:0.59.3@aar" level="project" />
    ...
    <orderEntry type="library" name="Gradle: org.osmdroid:osmdroid-android:6.1.5@aar" level="project" />
